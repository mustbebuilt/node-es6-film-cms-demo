...
import * as dbo from "../db/connection.js";
...
export const viewAllJSON = async (req, res) => {
...
export const getItem = async (req, res, view, viewTitle) => {
...
export const amendItem = async (req, res) => {
